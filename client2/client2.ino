...
void loop(){
	...
	if (client.connect("tsuts.tskoli.is",80)) { // REPLACE WITH YOUR SERVER ADDRESS
		client.println("POST /phph/add.php HTTP/1.1"); 
		client.println("Host: tsuts.tskoli.is"); // SERVER ADDRESS HERE TOO
